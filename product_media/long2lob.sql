...
DEFINE ctl_file = /opt/DMSTEX_dev/db-sample-schemas/product_media/long2lob.ctl
DEFINE dat_file = /opt/DMSTEX_dev/db-sample-schemas/product_media/long2lob.dat
DEFINE log_file = /opt/DMSTEX_dev/db-sample-schemas/log/longload.log
