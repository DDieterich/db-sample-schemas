...
@/opt/DMSTEX_dev/db-sample-schemas//order_entry/oe_views
...
DEFINE vscript = /opt/DMSTEX_dev/db-sample-schemas//order_entry/cmnt_&vrs
@&vscript

DEFINE vscript = /opt/DMSTEX_dev/db-sample-schemas//order_entry/cidx_&vrs
@&vscript
